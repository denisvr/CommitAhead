# CommitAhead - reproducible local dev database bootstrap: roles -> migrations -> RLS(users) -> RLS(Phase 2).
#
...
# already exist, EF migrations only apply what's pending, and 002_rls_users.sql/004_rls_phase2.sql
# both drop+recreate their policies instead of failing on a second run.
#
# Phases 1/3/4 (Study, Job Analyses/Interview Notes, AnalysisDrafts/AI) were removed along with
# their features and tables — only Phase 2 (Professional Profile/CV Presentations) remains.
#
