...
/// <summary>
/// Shared string/list/URL invariant checks for ProfessionalProfile and its child entities. A local
/// copy, not shared with <c>CommitAhead.Domain.StudyItems.TextValidation</c> — same precedent as
