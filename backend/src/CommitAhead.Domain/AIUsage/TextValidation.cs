...
/// <summary>
/// Shared string invariant checks for AIUsageRecord. A local copy, not shared with other
/// aggregates' <c>TextValidation</c> — same precedent as <see cref="ValidationLimits"/>. Never
/// truncates — every violation throws <see cref="DomainValidationException"/>.
/// </summary>
