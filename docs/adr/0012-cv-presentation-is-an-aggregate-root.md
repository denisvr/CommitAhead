...
CVPresentation was initially modelled as a child collection inside the singleton ProfessionalProfile. It later gained an independent lifecycle: direct create/update/delete use cases and export. Other aggregates therefore needed to reference a CVPresentation ID directly.
